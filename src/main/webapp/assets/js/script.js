...
(function(){
	...
	function setSlideNav(){
		jQuery(".toggleDrawer").click(function(e){
			...
			if($wrapper.css('marginLeft')=='0px'){
				...
				$wrapper.animate({marginLeft : -240},500);
			}
			else{
				$drawerRight.animate({marginRight : -240},500);
	...
	function setDisplayHeaderBackground() {		
		var scrollTop = jQuery(window).scrollTop(); // our current vertical position from the top	
		
			jQuery('#header .content-block header-wrapper .top').addClass('solid');
	}
