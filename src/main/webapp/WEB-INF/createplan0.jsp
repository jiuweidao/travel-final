						...
						<div class="row">
							<div class="col-md-6 col-md-offset-3-user-left">
								...
								<form id="message_form" class="form-user" role="form">
									<div class="form-group">
								    	<label>昵称：</label><input id="name" name="name" type="text" class="form-control-user form-control-white"  value="${users.name}" placeholder="Your Name" ><label id="name_error" style="display:none;">昵称：</label>
								  	</div>
								    <div class="form-group">
								    	<label>手机：</label><input id="telemoble" name="telemoble"type="text" class="form-control-user form-control-white" value="${users.telemoble}"  placeholder="Enter email"><label id="telemoble_error" style="display:none;">昵称：</label>
								    </div>
								    <div class="form-group">
								    	<label>邮箱：</label><input id="email" name="email" type="text" class="form-control-user form-control-white" value="${users.email}" placeholder="Enter email" ><label id="email_error" style="display:none;">昵称：</label>
								    </div>
								    <div class="form-group">
								  ...
								  <input id="modifyMessage_btn" type="button" class="btn btn-o-white" value="清空">
								</form>
							</div>
							<div class="col-md-6 col-md-offset-3-user-right">
								...
								<form id="password_form" class="form-user" role="form">
									<div class="form-group">
								    	<label>原密码：</label><input id="original_password" name="original_password" type="password" class="form-control-user form-control-white"  required>
								  	</div>
								    <div class="form-group">
								    	<label>新密码：</label><input id="password" name="password"  type="password" class="form-control-user form-control-white"  required>
								    </div>
								    <div class="form-group">
								    	<label>再输入：</label><input id="repassword" name="repassword"  type="password" class="form-control-user form-control-white" required>
								    </div>
