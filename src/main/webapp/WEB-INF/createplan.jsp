						...
						<div class="row">
							...
							<div class="col-md-6 col-md-offset-3-user-left">
									<div class="form-group">
								    	<label>邀约标题：</label>
								    	<input id="title" name="title" type="text" class="form-control-user form-control-white valid"  placeholder="搭车西藏七日">
								    	<label id="title_error" class="lable-error" style="display:none;" >不能为空</label>
							 		</div>
									<div class="form-group">
								    	<label>旅行标签：</label>
								    	<input id="tag" name="tag" type="text" class="form-control-user form-control-white valid"  placeholder="搭车西藏游" >
								    ...
								    <div class="form-group">
								    	<label>出发地点：</label>
								    	<input id="departureplace" name="departureplace" type="text" class="form-control-user form-control-white valid" placeholder="武汉">
								    	<label id="departureplace_error" class="lable-error" style="display:none;">不能為空</label>
								    </div>
								    <div class="form-group">
								    	<label>目的地点：</label>
								    	<input id="destination" name="destination"  type="text" class="form-control-user form-control-white valid" placeholder="西藏" >
								    	<label id="destination_error" class="lable-error"  style="display:none;">不能為空</label>
								    </div>
								    <div class="form-group">
								    	<label>期望人数：</label>
								    	<input id="expectnum" name="expectnum"  type="text" class="form-control-user form-control-white valid"  placeholder="20">
								    	<label id="expectnum_error" class="lable-error"  style="display:none;">不能為空</label>
								    </div>
								    <div class="form-group">
								    	<label>旅行预算：</label>
								    	<input id="budgetbottom" name="budgetbottom" type="text" class="form-control-user-half form-control-white valid"  placeholder="3000/人">
								   		 <span> ——</span>
								   		<input id="budgettop" name="budgettop" type="text" "  class="form-control-user-half form-control-white valid"  placeholder="6000/人">
								    </div>
								      <div class="form-group">
							...
							<div class="col-md-6 col-md-offset-3-user-right">
								...
								<div class="form-group">
								    	<textarea id="content" name="content"  class="form-control form-control-white valid" placeholder="Write Something" rows="10" required></textarea>
								</div>
							</div>
