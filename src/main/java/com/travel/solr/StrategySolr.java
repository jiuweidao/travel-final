...
public class StrategySolr {
	private String serverUrl = "http://localhost:8080/solr/core_strategy";
	 ...
	 */
	public void insert(Strategies strategies) throws SolrServerException, IOException {
		HttpSolrClient client = new HttpSolrClient(serverUrl);
		SolrInputDocument doc = new SolrInputDocument();

		doc.addField("id", strategies.getId());
		doc.addField("site", strategies.getSite());
		doc.addField("duration", strategies.getDuration());

		doc.addField("content", strategies.getContent());
		doc.addField("picpath", strategies.getPicpath());
		doc.addField("creatby", strategies.getCreatby());
		doc.addField("creattime", strategies.getCreattime());
